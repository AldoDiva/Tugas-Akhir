...
<div class="card-body">
    <div class="card px-2 pb-2">
        <div class="col-md-10 mt-1 mb-2"><button type="button" id="addNewHotel" class="btn btn-success">Add</button>
        </div>
        <div class="card">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $hotel->nama }}</td>
                                        <td>{{ $hotel->alamat}}</td>
                                        <td>{!!substr("$hotel->keterangan",0,25)!!}...</td>
                                        <td>{{ $hotel->no_telp }}</td>
                                        <td>{{ $hotel->lati }}</td>
                                        <td>{{ $hotel->longi }}</td>
                                        ...
                                        <div class="dropdown">
                                                ...
                                                <div class="dropdown-content">
                                                    <div><a href="javascript:void(0)" class="btn btn-primary edit" data-id="{{ $hotel->id }}">Edit</a></div>
                                                    <div><a href="javascript:void(0)" class="btn btn-danger delete" data-id="{{ $hotel->id }}">Delete</a></div>
                                                </div>
                                            </div>
    ...
    <div class="modal fade" id="ajax-hotel-model" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="ajaxHotelModel"></h4>
                </div>
                <div class="modal-body">
                    <form action="javascript:void(0)" id="addEditHotelForm" name="addEditHotelForm"
                        ...
                        <div class="col-sm-offset-2 col-sm-10">
                            <button type="submit" class="btn btn-primary" id="btn-save" value="addNewHotel">Save
                                changes
                            </button>
                        </div>
                    </form>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#addNewHotel').click(function () {
            $('#addEditHotelForm').trigger("reset");
            $('#ajaxHotelModel').html("Add Hotel");
            $('#ajax-hotel-model').modal('show');
        });
        ...
        $('body').on('click', '#btn-save', function (event) {
            ...
            var formData = new FormData($('#addEditHotelForm')[0]);

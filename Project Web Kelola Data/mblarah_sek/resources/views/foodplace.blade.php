                            ...
                            <tbody>
                                    ...
                                    <td>{{ $food->id }}</td>
                                        ...
                                        <td class="text-center">
                                            <div class="dropdown">
                                                <img src="{{ Storage::url($food->gambar1)}}" class="rounded"
                                        ...
                                        <td class="text-center">
                                            <div class="dropdown">
                                                <img src="{{ Storage::url($food->gambar2)}}" class="rounded"
                                                    style="height: 100px" width="150px">
                                                <div class="dropdown-content">
                                                    <img src="{{ Storage::url($food->gambar2)}}" class="rounded"
                                                        style="height: 200px" width="350px">
                                        ...
                                        <td class="text-center">
                                            <div class="dropdown">
                                                <img src="{{ Storage::url($food->gambar3)}}" class="rounded"
                                                    style="height: 100px" width="150px">
                                                <div class="dropdown-content">
                                                    <img src="{{ Storage::url($food->gambar3)}}" class="rounded"
                                                        style="height: 200px" width="350px">
                                        ...
                                        <td class="text-center">
                                            <div class="dropdown">
                                                <img src="{{ Storage::url($food->gambar4)}}" class="rounded"
                                                    style="height: 100px" width="150px">
                                                <div class="dropdown-content">
                                                    <img src="{{ Storage::url($food->gambar4)}}" class="rounded"
                                                        style="height: 200px" width="350px">
                                        ...
                                        <td class="text-center">
                                            <div class="dropdown">
                                                <img src="{{ Storage::url($food->gambar5)}}" class="rounded"
                                                    style="height: 100px" width="150px">
                                                <div class="dropdown-content">
                                                    <img src="{{ Storage::url($food->gambar5)}}" class="rounded"
                                                        style="height: 200px" width="350px">

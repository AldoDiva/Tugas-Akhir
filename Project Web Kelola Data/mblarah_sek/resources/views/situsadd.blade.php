                        ...
                        <table class="table">
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <img src="{{ Storage::url($situs->gambar1)}}" class="rounded" style="height: 100px" width="150px">
                                        </td>
                                        <td class="text-center">
                                        <img src="{{ Storage::url($situs->gambar2)}}" class="rounded" style="height: 100px" width="150px">
                                        </td>
                                        <td class="text-center">
                                        <img src="{{ Storage::url($situs->gambar3)}}" class="rounded" style="height: 100px" width="150px">
                                        </td>
